...
const ATP_PLAYERS = [
  {
    ...
    titles: 'Australian Open 2024 & 2025, US Open 2024, Wimbledon 2025 & 2026',
    style: 'Baseline Powerhouse',
    bio: 'Five Grand Slam titles and back-to-back Wimbledon crowns. Relentless from the back of the court with one of the best two-handed backhands in the game.',
  ...
  },
  {
    ...
    country: 'Germany', flag: '🇩🇪', ranking: 2,
    titles: 'Roland Garros 2026, Olympic Gold 2021, ATP Finals 2018 & 2021',
    style: 'Big Server & Baseline',
    bio: 'First German Grand Slam champion since Boris Becker. A devastating serve and complete baseline game carried him to back-to-back Slam finals in 2026.',
  ...
  {
    name: 'Carlos Alcaraz',
    country: 'Spain', flag: '🇪🇸', ranking: 3,
    titles: 'Australian Open 2026, Wimbledon 2023 & 2024, Roland Garros 2024 & 2025, US Open 2022 & 2025',
    style: 'All-Court Attacker',
    bio: 'Seven Grand Slam titles and the youngest man to complete a Career Grand Slam. Explosive athleticism, elite drop shots, and dominance on every surface.',
  ...
  },
  {
    ...
    country: 'Canada', flag: '🇨🇦', ranking: 4,
    titles: '9 ATP titles including Montpellier 2026',
    style: 'Powerful All-Rounder',
    bio: 'A big serve and explosive forehand combined with improving consistency have propelled the Canadian to a career-high No. 4 ranking.',
    bg: 'from-emerald-500 to-green-700',
    accent: 'bg-emerald-100 text-emerald-700',
    wiki: 'https://en.wikipedia.org/wiki/F%C3%A9lix_Auger-Aliassime',
  },
  {
    name: 'Alex de Minaur',
    country: 'Australia', flag: '🇦🇺', ranking: 5,
    titles: '11 ATP titles',
    style: 'Speed & Counter-Punching',
    bio: 'One of the fastest players on tour with relentless court coverage and fighting spirit. Reached a career-high No. 5 in July 2026.',
    bg: 'from-violet-500 to-purple-700',
    accent: 'bg-violet-100 text-violet-700',
    wiki: 'https://en.wikipedia.org/wiki/Alex_de_Minaur',
  },
]
...
const WTA_PLAYERS = [
  {
    ...
    titles: 'Australian Open 2023 & 2024, US Open 2023 & 2024',
    style: 'Aggressive Baseliner',
    bio: 'Four Grand Slam titles and 24 career singles titles. Thunderous serve and forehand paired with elite consistency make her the dominant force on tour.',
  ...
  {
    name: 'Elena Rybakina',
    country: 'Kazakhstan', flag: '🇰🇿', ranking: 2,
    titles: 'Australian Open 2026, Wimbledon 2022, WTA Finals 2025',
    style: 'Big Serve & Flat Striker',
    bio: 'Two Grand Slam titles and 13 career wins. One of the biggest serves in women\'s tennis combined with flat, penetrating groundstrokes.',
  ...
  },
  {
    ...
    titles: '11 WTA titles including Charleston & Dubai 2026',
    style: 'Consistent Counter-Puncher',
    bio: 'Four WTA 1000 titles and a tenacious competitor. Her consistency and court craft have elevated her to a career-best No. 3 ranking.',
    bg: 'from-red-500 to-rose-700',
    accent: 'bg-red-100 text-red-700 dark:text-red-400',
    wiki: 'https://en.wikipedia.org/wiki/Jessica_Pegula',
  },
  {
    name: 'Coco Gauff',
    country: 'USA', flag: '🇺🇸', ranking: 4,
    titles: 'US Open 2023, Roland Garros 2025, WTA Finals 2024',
    style: 'All-Court Power Player',
    bio: 'Eleven career titles with exceptional serve, powerful groundstrokes and elite athleticism. A leader on and off court at just 22 years old.',
  ...
  },
  {
    ...
    titles: 'Roland Garros 2026, Indian Wells 2025, Dubai 2025',
    style: 'Aggressive All-Court',
    bio: 'The youngest French Open champion of the 21st century at 19. Six career titles with fearless shot-making and a rapidly maturing all-court game.',
    bg: 'from-amber-500 to-orange-600',
    accent: 'bg-amber-100 text-amber-700',
    wiki: 'https://en.wikipedia.org/wiki/Mirra_Andreeva',
  },
]
