...
const MatchStatsPage = lazy(() => import('./pages/MatchStatsPage'))
        ...
        {dropdownOpen && (
          <>
            ...
            <div className="absolute right-0 top-full mt-1 w-56 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50 py-1">
              ...
              <button
                onClick={() => { setDropdownOpen(false); logout({ logoutParams: { returnTo: window.location.origin } }) }}
            ...
            <div className="py-2">
              ...
              {isApproved && (
                <>
                  ...
                  <MobileNavItem to="/performance" label="Performance" icon={icons.performance} onClick={closeMenu} />
...
function AppRoutes() {
  return (
    ...
    <Routes>
      ...
      <Route path="/history/:matchId/stats" element={<Layout><ProtectedRoute><MatchStatsPage /></ProtectedRoute></Layout>} />
      <Route path="/performance" element={<Layout><ProtectedRoute><PerformancePage /></ProtectedRoute></Layout>} />
